    ...
    private RoundedPanel createDataPanel() {
        ...
        restockButton.addActionListener(e -> {
            if (selectedRow >= 0) {
                ...
                rightPanel.add(tanggalExpiredBaruField);

                rightPanel.add(new JLabel("Harga Beli (Baru):"));
                JTextField hargaBeliBaruField = new JTextField();
                rightPanel.add(hargaBeliBaruField);

                rightPanel.add(new JLabel("Harga Jual (Baru):"));
                JTextField hargaJualBaruField = new JTextField();
                rightPanel.add(hargaJualBaruField);
